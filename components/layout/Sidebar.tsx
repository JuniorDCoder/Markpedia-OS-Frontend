    ...
    work: [
        {
            ...
            href: '/work/projects',
            icon: Briefcase,
            roles: ['CEO', 'Admin', 'Manager', 'Employee', 'CXO', 'HR', 'Team Lead', 'Cashier'],
            phase: 1,
        },
        {
            name: 'Tasks',
        ...
        },
        {
            ...
            href: '/work/problems',
            icon: Shield,
            roles: ['CEO', 'Admin', 'Manager', 'Employee', 'CXO', 'HR', 'Team Lead'],
            phase: 1,
        },
        {
        ...
        },
        {
            ...
            icon: Briefcase,
            roles: ['CEO', 'Admin', 'Manager', 'CXO', 'HR'],  // Removed Employee
            phase: 1,
        },
        {
            name: 'Departments',
            ...
            icon: Building,
            roles: ['CEO', 'Admin', 'Manager', 'HR'],  // Removed Employee, CXO
            phase: 1,
        },
        {
            name: 'Roles',
            href: '/work/roles',
            icon: UserCog,
            roles: ['CEO', 'Admin', 'HR'],  // Removed CXO
            phase: 1,
        },
    ],
    people: [
        {
            ...
            icon: Users,
            roles: ['CEO', 'Admin', 'HR'],  // Removed Manager, CXO, Team Lead - they see team in dashboard
            phase: 1,
        },
        {
            name: 'Attendance',
            ...
            icon: UserCheck,
            roles: ['CEO', 'Admin', 'Manager', 'CXO', 'Employee', 'HR', 'Team Lead', 'Cashier'],
            phase: 1,
        },
        {
            name: 'Leave Requests',
        ...
        },
        {
            ...
            icon: TrendingUp,
            roles: ['CEO', 'Admin', 'Manager', 'CXO', 'HR', 'Employee', 'Team Lead', 'Cashier'],  // Added Employee
            phase: 1,
        },
        {
            name: 'Warnings & PIPs',
            ...
            icon: Shield,
            roles: ['CEO', 'Admin', 'Manager', 'CXO', 'Employee', 'HR', 'Team Lead'],
            phase: 1,
        },
    ],
    money: [
        {
            ...
            href: '/money/cashbook',
            icon: Wallet,
            roles: ['CEO', 'Admin', 'CFO', 'Accountant', 'Cashier'],  // Removed CXO
            phase: 1,
        },
        {
            name: 'Cash Flow',
            href: '/money/cash-flow',
            icon: TrendingUp,
            roles: ['CEO', 'Admin', 'CFO', 'Accountant', 'Cashier'],  // Removed CXO
            phase: 1,
        },
        {
            ...
            icon: DollarSign,
            roles: ['CEO', 'Admin', 'Manager', 'Employee', 'CFO', 'Cashier', 'HR', 'Team Lead'],  // Removed CXO
            phase: 1,
        },
        {
            name: 'Invoices',
            href: '/money/invoices',
            icon: FileText,
            roles: ['CEO', 'Admin', 'CFO', 'Accountant', 'Cashier'],  // Removed CXO, Manager
            phase: 1,
        },
        {
            name: 'Revenue',
    ...
    strategy: [
        {
            ...
            href: '/strategy/goals',
            icon: Target,
            roles: ['CEO', 'Admin', 'Manager', 'CXO', 'HR', 'Team Lead'],
            phase: 1,
        },
        {
            name: 'Journal',
        ...
        },
        {
            ...
            icon: Users,
            roles: ['CEO', 'Admin', 'Manager', 'CXO', 'HR'],
            phase: 1,
        },
        {
            name: 'Organigram',
