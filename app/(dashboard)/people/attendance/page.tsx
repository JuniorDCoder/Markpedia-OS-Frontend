...
import { Calendar, Clock, Users, Download, ChevronLeft, ChevronRight, Filter, Plus } from 'lucide-react';
...
export default function AttendancePage() {
    ...
    const loadAttendance = async () => {
        try {
            setLoading(true);
            // Mock data - filter by selected employee if privileged user
            ...
            for (let d = new Date(startDate); d <= endDate; d.setDate(d.getDate() + 1)) {
                ...
                if (dayOfWeek !== 0 && dayOfWeek !== 6) {
                    ...
                    mockAttendance.push({
                        id: `${d.getTime()}-${userId}`,
                        userId: userId,
                        userName: isPrivilegedUser ? employees.find(e => e.id === userId)?.name || 'Employee' : 'You',
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">
                        {isPrivilegedUser ? 'Track employee attendance and working hours' : 'View and manage your attendance'}
                    </p>
                </div>
                            ...
                            <div key={record.id} className="flex items-center justify-between p-3 border rounded-lg">
                                <div className="space-y-1">
                                    ...
                                    <div className="text-sm text-muted-foreground">
                                        {isPrivilegedUser && record.userName && (
