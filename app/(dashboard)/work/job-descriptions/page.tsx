            ...
            {filteredJobDescriptions.length === 0 ? (
                <Card>
                    <CardContent className="pt-6">
                        <div className="text-center py-12">
                            ...
                            <h3 className="text-lg font-medium text-muted-foreground mb-2">No job descriptions found</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {filteredJobDescriptions.map(jd => (
                        <Card key={jd.id} className="hover:shadow-md transition-shadow h-full flex flex-col">
                            <CardHeader className="pb-3">
                                <div className="flex items-start justify-between">
                                    <div className="space-y-2 flex-1">
                                        ...
                                        <CardDescription className="line-clamp-2">{jd.summary}</CardDescription>
                                        ...
                                        <ul className="text-sm text-muted-foreground space-y-1">
                                            ...
                                            {jd.responsibilities.length > 3 && (
                                                <li className="text-xs text-muted-foreground">
                                                    +{jd.responsibilities.length - 3} more responsibilities
                                                </li>
                                            )}
                                        </ul>
                                    </div>
